...
public class ClientViewProjectActivity extends AppCompatActivity {
    private String TAG=ClientViewProjectActivity.class.getSimpleName();
...
//TODO:client cannot add tasks
               // startActivity(new Intent(ClientViewProjectActivity.this,DashBoardActivity.class));
            }
        });
        ...
        floatingActionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent= new Intent(ClientViewProjectActivity.this,CreateProjectActivity.class);
                    ...
                    public void onResponse(JSONArray response) {
                        ...
                        try {
                            ...
                            ListAdapter adapter = new SimpleAdapter(
                                    ClientViewProjectActivity.this, projectList,
