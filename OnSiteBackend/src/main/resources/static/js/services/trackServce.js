(function () {
    ...
    trackService.$inject = ['$http' , 'serverSettings','$filter'];

    function trackService($http , serverSettings, $filter) {
        ...
        function details() {
            ...
            return $http.get(webApi + 'issues/get/all/{projectId}' ).then(handleSuccess, handleError('Loging error'));
           /* var p = {"projects" : [{
                            "projectID": 1,
                            "projectName": "test1"
                        },
